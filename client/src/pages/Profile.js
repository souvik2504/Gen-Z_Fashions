...
const handleChange = (e) => {
    ...
    try {
      ...
      setFormData({
        ...
        address: {
          ...
          country: updatedUser.address?.country || 'India'
        }
      });
  ...
  if (!isAuthenticated) {
    return (
      <div className="container mx-auto px-4 py-8 text-center bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors">
  ...
  return (
    <PageLoader loading={loading} text="Loading your profile...">
      ...
      <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-colors"
            ...
            <div className="pt-6">
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-600 dark:bg-blue-700 text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-700 dark:hover:bg-blue-600 disabled:bg-gray-400 dark:disabled:bg-gray-600 disabled:cursor-not-allowed flex items-center justify-center space-x-2 transition-colors"
              >
                {loading ? (
                  <>
        ...
        <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 mt-6 transition-colors">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            <p><strong className="text-gray-800 dark:text-gray-300">Account Type:</strong> {user?.role === 'admin' ? 'Administrator' : 'Customer'}</p>
            <p><strong className="text-gray-800 dark:text-gray-300">Member Since:</strong> {new Date(user?.createdAt).toLocaleDateString()}</p>
          </div>
        </div>
      </div>
    </div>
